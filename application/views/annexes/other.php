<div class="wrap-assistance bg-dark m-0 p-3">
	<section class="row pt-5 mt-0">
		<h2 class="titre-assistance col-12 offset-1">Rubrique Assistance</h2>
	</section>
	<section id="service" class="row offset-1 my-3 section-info">
		<div class="row col-11 pl-5 py-0">
			<h3>Service</h3>	
		</div>
	...
	<section id="info" class="row offset-1 my-3 section-info">
		<div class="row col-11 pl-5 py-0">
			<h3>Info</h3>	
		</div>
		<article class="col-sm-12 col-lg-6 py-2">
